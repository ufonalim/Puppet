...
config.vm.define :vm1 do |vm1|
  vm1.vm.hostname = "vm1"
  vm1.vm.network "private_network", ip: "192.168.10.11"
  vm1.vm.network "forwarded_port", guest: 80, host: 8081
  vm1.vm.boot_timeout = 3000
end

#master
config.vm.define :vm2 do |vm2|
  vm2.vm.hostname = "vm2"
  vm2.vm.network "private_network", ip: "192.168.10.12"
  vm2.vm.network "forwarded_port", guest: 80, host: 8082
  vm2.vm.boot_timeout = 3000
end

#node2
config.vm.define :vm3 do |vm3|
  vm3.vm.hostname = "vm3"
  vm3.vm.network "private_network", ip: "192.168.10.13"
